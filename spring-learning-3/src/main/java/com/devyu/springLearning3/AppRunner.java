/*
 * package com.devyu.springLearning3; import
 ...
 * System.err.println(ctx.getBean("single"));
 * 
 * // 싱글톤 타입의 프로토타입 property는 계속 같은 인스턴스만 출력됨 // 해결방안 // 1.proxyMode =
 * scopedProxyMode.TARGET_CLASS // why? - proxy를 거쳐서 참조하기 때문에 // 2.
 * ObjectFactory<Proto> System.err.println("== 싱글톤의 프로토타입 property ==");
